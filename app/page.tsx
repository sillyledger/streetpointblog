        ...
        <div className="mx-auto max-w-5xl px-6 pb-[40px] pt-[44px]">
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-[1fr_auto] sm:items-end">
            ...
            <div className="min-w-[150px] border-l border-ink/25 pl-5">
              <dl>
                <div className="flex items-center justify-between border-b border-dotted border-ink/25 py-2 font-mono text-[10.5px] uppercase tracking-[0.1em]">
                ...
                <div className="flex items-center justify-between py-2 font-mono text-[10.5px] uppercase tracking-[0.1em]">
                  <dt className="text-faint">Filed from</dt>
                  <dd className="text-ink">TCH / LDN</dd>
                </div>
              </dl>
            </div>
          </div>
